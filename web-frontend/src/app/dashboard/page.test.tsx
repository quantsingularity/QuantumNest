...
describe("Dashboard Page", () => {
  ...
  test("renders portfolio chart", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByRole("img", { name: /portfolio chart/i }),
      ).toBeInTheDocument();
    });
  });
  ...
  test("renders market chart", async () => {
    ...
    await waitFor(() => {
      ...
      expect(
        screen.getByRole("img", { name: /market chart/i }),
      ).toBeInTheDocument();
    });
  });
  ...
  test("handles chart data error", async () => {
    ...
    jest
      .spyOn(require("@/lib/charts"), "getPortfolioChartData")
  ...
  test("handles market data error", async () => {
    ...
    jest.spyOn(console, "error").mockImplementation(() => {});
    jest
      .spyOn(require("@/lib/charts"), "getMarketChartData")
      .mockRejectedValueOnce(mockError);
