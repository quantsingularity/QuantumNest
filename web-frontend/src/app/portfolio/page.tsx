      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {activeTab === "performance" && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              This tab would contain detailed performance metrics, historical
              charts, and comparison with benchmarks.
            </p>
          </div>
        )}
        ...
        {activeTab === "transactions" && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              This tab would display a complete history of all portfolio
              transactions with filtering options.
            </p>
          </div>
        )}
      </main>
