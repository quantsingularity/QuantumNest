            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                        Advanced machine learning models providing investment insights and portfolio
                        optimization.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                        Our AI models have consistently improved in accuracy over time, with the
                        latest ensemble approach achieving over 90% accuracy in market trend
                        predictions.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                        Comparison of our different AI models across key performance metrics. The
                        ensemble approach combines the strengths of individual models for superior
                        results.
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                        Our AI-optimized portfolio aims to maximize the Sharpe ratio, providing
                        better risk-adjusted returns compared to traditional allocation strategies.
                    </p>
                </div>
                ...
                <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl shadow-lg p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Generalized Autoregressive Conditional Heteroskedasticity models are
                                specifically designed to capture volatility clustering in financial
                                markets, providing robust risk assessments.
                            </p>
                        </div>
                        <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                            <div className="flex items-center mb-3">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                    <div className="flex items-start mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">
                                Complete your risk profile and investment goals to receive tailored
