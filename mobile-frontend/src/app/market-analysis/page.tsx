    ...
    const marketPerformanceData = {
        ...
        datasets: [
            ...
            },
            {
                label: 'NASDAQ',
                data: [
                    15000, 14800, 15200, 15500, 15800, 15600, 16000, 16200, 16400, 16600, 16700,
                    16780,
                ],
        ...
        <div className="space-y-6">
            ...
            {activeTab === 'stocks' && (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        This tab would contain detailed stock market data, sector analysis, and
            ...
            {activeTab === 'crypto' && (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                        This tab would display cryptocurrency market data, token information, and
