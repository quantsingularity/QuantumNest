...
from app.models.models import db, User, Account, Portfolio, Transaction
...
from app.middleware.security_middleware import SecurityMiddleware, SecurityConfig
        ...
        try:
            ...
            if result.success:
                ...
                return jsonify({
                    ...
                    'temp_session': result.session_token if result.requires_2fa else None
                }), 401
