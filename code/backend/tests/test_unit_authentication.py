...
class TestAdvancedAuthenticationSystem:
    ...
    async def test_authenticate_user_success(self, auth_system, db_session, test_user):
        ...
        auth_system._create_session = Mock(return_value=SessionInfo(
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_invalid_password(self, auth_system, db_session, test_user):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_account_locked(self, auth_system, db_session, test_user):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_requires_2fa(self, auth_system, db_session, test_user):
    ...
    def test_validate_token_expired(self, auth_system):
        ...
        token = jwt.encode(payload, auth_system.jwt_secret, algorithm=auth_system.jwt_algorithm)
    ...
    def test_generate_tokens(self, auth_system):
        ...
        # Decode and verify
        payload = jwt.decode(access_token, auth_system.jwt_secret, algorithms=[auth_system.jwt_algorithm])
        ...
        # Decode and verify
        payload = jwt.decode(refresh_token, auth_system.jwt_secret, algorithms=[auth_system.jwt_algorithm])
        assert payload['user_id'] == user_id
        assert payload['session_id'] == session_id
...
class TestSecurityFeatures:
    ...
    @pytest.mark.asyncio
    async def test_calculate_authentication_risk_new_device(self, auth_system, db_session, test_user):
    ...
    @pytest.mark.asyncio
    async def test_calculate_authentication_risk_known_device(self, auth_system, db_session, test_user):
